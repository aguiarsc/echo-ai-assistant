 ...
 * Use Gemini's natural language understanding to parse user intent
 */
...
import { buildConversationContext } from "@/lib/ai/gemini/utils/message-formatter.utils";
import { FileCreationIntent, FileEditIntent, IntentResult } from "@/lib/ai/types";

/**
 * Use Gemini to parse user intent for file operations with conversation context
