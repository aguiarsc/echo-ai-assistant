...
import { GEMINI_MODELS } from "@/domains/conversations/types/conversation.types"
import { Edit, MessageCircle, Plus, Settings, Trash, Folder, Pin, PinOff, Moon, Sun } from "lucide-react"
import { useState } from "react"
import { ScrollArea } from "@/shared/ui-components/scroll-area"
import { ConversationSettings } from "@/domains/conversations/components/ConversationSettings"
import Image from "next/image"
import { FilesTab } from "@/domains/writing-projects/components/ProjectTab"
    ...
    <>
      ...
      <Dialog open={settingsOpen} onOpenChange={setSettingsOpen}>
        <DialogContent className="max-w-lg max-h-[85vh] overflow-y-auto">
          ...
          <ConversationSettings onClose={() => setSettingsOpen(false)} />
        </DialogContent>
      </Dialog>
    </>
  )
