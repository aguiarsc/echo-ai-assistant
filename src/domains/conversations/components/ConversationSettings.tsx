...
import { GEMINI_MODELS, DEFAULT_GENERATION_PARAMS, HarmBlockThreshold, HarmCategory } from "@/domains/conversations/types/conversation.types"
...
import { ThemeTab } from "@/application/theme-management/theme-settings"
...
export function ConversationSettings({ onClose }: SettingsPanelProps) {
  const { 
    apiKey, 
    setApiKey,
    generationParams,
