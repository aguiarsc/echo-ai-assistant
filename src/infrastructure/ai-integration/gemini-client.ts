...
import { 
  ...
  GenerationParams, 
  ChatMessage
} from "@/domains/conversations/types/conversation.types";
import { buildGenerationConfig, buildContentWithFiles } from "./request-builder";
import { formatMessagesForAPI, getLastUserMessage, getHistoryExceptLast } from "./message-formatter";
import { processStreamResponse, extractThinkingAndAnswer } from "./response-handler";
