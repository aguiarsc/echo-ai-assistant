...
import { themes } from '@/application/theme-management/theme-definitions';
...
export function ThemeTab() {
  ...
  const renderPreviewColors = (preview: { primary: string; secondary: string; background: string; foreground: string }): JSX.Element => {
